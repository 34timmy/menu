 ...
 */
var TopJavaModule = (function () {
    function TopJavaModule() {
    }
    TopJavaModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, http_1.HttpModule, app_routes_1.routing, calendar_1.CalendarModule, datatable_1.DataTableModule, growl_1.GrowlModule],
    ...
    return TopJavaModule;
}());
exports.TopJavaModule = TopJavaModule;
